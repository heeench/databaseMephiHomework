...
2. Создадим таблицы, запустив скрипт из файла homework/vehicles/create_tables.sql.
3. Наполним таблицы данными с помощью скрипта homework/vehicles/insert_data.sql.
...
Решение:
размещено в скрипте homework/vehicles/task1.sql.
...
Решение:
размещено в скрипте homework/vehicles/task2.sql.
...
2. Создадим таблицы, запустив скрипт из файла homework/races/create_tables.sql.
3. Наполним таблицы данными с помощью скрипта homework/races/insert_data.sql.
...
Решение:
размещено в скрипте homework/races/task1.sql.
...
Решение:
размещено в скрипте homework/races/task2.sql.
...
Решение:
размещено в скрипте homework/races/task3.sql.
...
Решение:
размещено в скрипте homework/races/task4.sql.
...
Решение:
размещено в скрипте homework/races/task5.sql.
...
Решение:
размещено в скрипте homework/hotels/task2.sql.
...
Решение:
размещено в скрипте homework/hotels/task3.sql.
...
2. Создадим таблицы, запустив скрипт из файла homework/company/create_tables.sql.
3. Наполним таблицы данными с помощью скрипта homework/company/insert_data.sql.
...
Решение:
размещено в скрипте homework/company/task1.sql.
...
Решение:
размещено в скрипте homework/company/task2.sql.
...
Решение:
размещено в скрипте homework/company/task3.sql.